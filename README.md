...
In order to unlock these funds, CycMiner must pay 500 satoshis to the first invoice. Paying this invoice will reveal a "secret"; this secret can then be used to unlock the HODL invoice.
